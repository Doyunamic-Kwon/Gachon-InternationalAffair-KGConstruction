...
> 관계 추출(Relation Extraction)의 **지도 → 반지도 → 비지도 → 딥러닝** 4가지 패러다임을 직접 구현하고 성능을 비교 분석합니다.  
...
8. [Step 5 — Deep Learning](#8-step-5--deep-learning)
9. [전체 실험 결과 분석](#9-전체-실험-결과-분석)
10. [Part 2 — KLUE-RE 벤치마크](#10-part-2--klue-re-벤치마크)
11. [실험 재현](#11-실험-재현)
12. [파일 구조](#12-파일-구조)
13. [참고 문헌](#13-참고-문헌)
...
```
Kernel SVM (0.8627) > RF (0.7300) > Snowball (0.4787) > DIPRE (0.4010) > Bi-LSTM (0.3624)
```
