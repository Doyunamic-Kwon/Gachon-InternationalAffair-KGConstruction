...
**시각화**: `docs/corpus_quality_improvement.png` — 윈도우/LLM/템플릿 비율 및 패턴 품질 분포
...
**시각화**:
- `docs/step3_feature_based.png` — Random Forest 혼동 행렬 및 성능 지표
- `docs/feature_importance.png` — 피처 중요도 순위
...
**시각화**:
- `docs/step4_kernel_svm.png` — Kernel SVM 혼동 행렬 및 성능 지표
- `docs/kernel_confusion_matrix.png` — 자세한 관계별 혼동 분석
- `docs/kernel_tsne.png` — Kernel SVM이 학습한 임베딩 공간의 t-SNE 시각화
...
**시각화**:
- `docs/dipre_iteration_f1.png` — 상위 6개 관계의 반복별 F1 진행 곡선
- `docs/dipre_discovered_tuples.png` — 각 반복에서 발견된 총 튜플 수
- `docs/step2_semi_supervised.png` — DIPRE vs Snowball 성능 비교
- `docs/semi_supervised_per_relation.png` — 관계별 반지도 성능 분석
- `docs/semantic_drift_comparison.png` — DIPRE의 의미 표류 문제 시각화
...
**시각화**:
- `docs/unsupervised_comparison_v2.png` — V-Measure 분해 (동질성 × 완전성)
- `docs/step1_unsupervised_comparison.png` — 방법론별 성능 비교
- `docs/step1_unsupervised_tsne.png` — t-SNE로 시각화한 클러스터 분포
- `docs/open_ie_analysis.png` — 개방형 정보 추출 패턴 분포
...
**시각화**:
- `docs/noise_labels_analysis.png` — 관계별 클러스터 순수도 분석 (노이즈 레이블 시각화)
- `docs/oia_domain_insight.png` — OIA 도메인 특성과 비지도 학습의 한계
...
**시각화**:
- `docs/step5_deep_learning.png` — BiLSTM 아키텍처 및 학습 결과
- `docs/step5_training_curve.png` — 학습/검증 손실 곡선 (과적합 시각화)
- `docs/step5_confusion_matrix.png` — 테스트 셋 혼동 행렬
- `docs/attention_heatmap.png` — Attention 메커니즘이 중요시한 토큰 시각화
...
**시각화**:
- `docs/final_pipeline_comparison.png` — 4가지 패러다임 최종 성능 비교
- `docs/final_comparison_updated.png` — 막대 그래프로 보는 방법론별 F1 점수
- `docs/step6_final_comparison.png` — 상세한 성능 지표 비교
...
**시각화**:
- `docs/klue_final_comparison.png` — KLUE 벤치마크 방법론별 성능
- `docs/klue_class_distribution.png` — KLUE 데이터셋 클래스 분포
- `docs/klue_feature_confusion_matrix.png` — Random Forest KLUE 성능
- `docs/klue_feature_importance.png` — KLUE에서의 피처 중요도
- `docs/klue_kernel_tsne.png` — KLUE에서 학습한 Kernel SVM 임베딩 공간
- `docs/klue_unsupervised_comparison.png` — KLUE 비지도 학습 성능
- `docs/klue_unsupervised_tsne.png` — KLUE 비지도 클러스터링 t-SNE
- `docs/klue_attention_heatmap.png` — KLUE 테스트셋 Attention 분석
- `docs/klue_semantic_drift_comparison.png` — KLUE DIPRE 의미 표류 분석
